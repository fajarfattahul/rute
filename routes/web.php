...
Route::group(['prefix' => '/admin', 'namespace' => 'Admin'], function () {
    ...
    Route::group(['prefix' => '/lokasi'], function () {
        ...
        Route::get('/deletelokasi/{id}', 'LokasiController@destroy')->name('deletelokasi');
    });
    //====================================================================================//
    ...
    Route::group(['prefix' => '/kendaraan'], function () {
        ...
        Route::get('/deletekendaraan/{id}', 'KendaraanController@destroy')->name('deletekendaraan');
    });
    //====================================================================================//
    ...
    Route::group(['prefix' => '/barang'], function () {
        ...
        Route::get('/deletebarang/{id}', 'BarangController@destroy')->name('deletebarang');
    });
    //====================================================================================//
});
